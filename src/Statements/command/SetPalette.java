...
/**
 * This command sets the palette with the new color obtains. To add, the user needs to put in a
 * number + 1 of the maximum index. It also takes in the RGB code to definte the color
 * 
