...
public class ViewFunctions {
    ...
    public static Paint paintFromPath(String path){
        ResourceBundle stringResources = ResourceBundle.getBundle("resources.View.ViewText",new Locale("en", "US"));
        List<String> imageExtArray = Arrays.asList(stringResources.getString("imageFileExtension").split("\\s+"));
