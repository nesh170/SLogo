...
public class SelectPane {
	...
	public SelectPane(Group root, EventHandler<ActionEvent> handler,
	...
	private ChoiceBox<String> generateColorBox(
			ChangeListener<Number> listener) {
